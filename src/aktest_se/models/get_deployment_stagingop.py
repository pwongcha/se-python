...
class GetDeploymentStagingRequestTypedDict(TypedDict):
    enrollment_id: int
...
class GetDeploymentStagingRequest(BaseModel):
...
class GetDeploymentStagingKeyAlgorithm(str, Enum):
...
class GetDeploymentStagingSignatureAlgorithm(str, Enum):
...
class GetDeploymentStagingMultiStackedCertificatesTypedDict(TypedDict):
    ...
    key_algorithm: NotRequired[GetDeploymentStagingKeyAlgorithm]
    r"""The key algorithm of the certificate. This is either `ECDSA` or `RSA`."""
    signature_algorithm: NotRequired[Nullable[GetDeploymentStagingSignatureAlgorithm]]
    r"""Indicates the SHA (Secure Hash Algorithm) function. You can use either `SHA-1` for a 160-bit (20-byte) hash or `SHA-256` for a 256-bit (32-byte) hash."""


class GetDeploymentStagingMultiStackedCertificates(BaseModel):
    certificate: Nullable[str]
    r"""The certificate text."""
    ...
    key_algorithm: Annotated[
        Optional[GetDeploymentStagingKeyAlgorithm], pydantic.Field(alias="keyAlgorithm")
    ] = None
    r"""The key algorithm of the certificate. This is either `ECDSA` or `RSA`."""

    signature_algorithm: Annotated[
        OptionalNullable[GetDeploymentStagingSignatureAlgorithm],
...
class GetDeploymentStagingGeography(str, Enum):
...
class GetDeploymentStagingOcspStapling(str, Enum):
...
class GetDeploymentStagingSecureNetwork(str, Enum):
...
class GetDeploymentStagingNetworkConfigurationTypedDict(TypedDict):
    ...
    geography: NotRequired[GetDeploymentStagingGeography]
    r"""Specifies the type of network where you want to deploy your certificate.  Use `core` to deploy across most of the world except for specially licensed areas.  Use `china+core` to include China, or `russia+core` to include Russia. Any non-`core` deployment needs to be enabled on your contract based on approval from the Chinese or Russian governments."""
    ...
    ocsp_stapling: NotRequired[GetDeploymentStagingOcspStapling]
    r"""Indicates the OCSP stapling setting for the deployment. Use `on` to enable OCSP stapling, `off` to disable it, or `not-set` to ignore it."""
    ...
    secure_network: NotRequired[GetDeploymentStagingSecureNetwork]
    r"""Identifies the type of deployment network. An `enhanced-tls` value means Akamai's more secure network with PCI compliance capability, while `standard-tls` means Akamai's standard secure network."""


class GetDeploymentStagingNetworkConfiguration(BaseModel):
    r"""Network configuration properties."""
    ...
    geography: Optional[GetDeploymentStagingGeography] = None
    r"""Specifies the type of network where you want to deploy your certificate.  Use `core` to deploy across most of the world except for specially licensed areas.  Use `china+core` to include China, or `russia+core` to include Russia. Any non-`core` deployment needs to be enabled on your contract based on approval from the Chinese or Russian governments."""
    ...
    ocsp_stapling: Annotated[
        Optional[GetDeploymentStagingOcspStapling], pydantic.Field(alias="ocspStapling")
    ] = None
    r"""Indicates the OCSP stapling setting for the deployment. Use `on` to enable OCSP stapling, `off` to disable it, or `not-set` to ignore it."""
    ...
    secure_network: Annotated[
        Optional[GetDeploymentStagingSecureNetwork],
        pydantic.Field(alias="secureNetwork"),
    ] = None
    r"""Identifies the type of deployment network. An `enhanced-tls` value means Akamai's more secure network with PCI compliance capability, while `standard-tls` means Akamai's standard secure network."""


class GetDeploymentStagingDeploymentsKeyAlgorithm(str, Enum):
...
class GetDeploymentStagingDeploymentsSignatureAlgorithm(str, Enum):
...
class GetDeploymentStagingPrimaryCertificateTypedDict(TypedDict):
    ...
    expiry: NotRequired[str]
    r"""The expiration date for the certificate."""
    key_algorithm: NotRequired[GetDeploymentStagingDeploymentsKeyAlgorithm]
    r"""The key algorithm for the multi-stacked certificate. This is either `ECDSA` or `RSA`."""
    signature_algorithm: NotRequired[
        Nullable[GetDeploymentStagingDeploymentsSignatureAlgorithm]
    ]
    r"""Identifies the SHA (Secure Hash Algorithm) function. The NSA (National Security Agency) designed this function to produce a hash of certificate contents, which is used in a digital signature. This is either `SHA-1` for a 160-bit (20-byte) hash or `SHA-256` for a 256-bit (32-byte) hash. To ensure a secure hash function, use `SHA-256`."""


class GetDeploymentStagingPrimaryCertificate(BaseModel):
    r"""Primary certificate of the enrollment."""
    ...
    key_algorithm: Annotated[
        Optional[GetDeploymentStagingDeploymentsKeyAlgorithm],
        pydantic.Field(alias="keyAlgorithm"),
    ] = None
    r"""The key algorithm for the multi-stacked certificate. This is either `ECDSA` or `RSA`."""

    signature_algorithm: Annotated[
        OptionalNullable[GetDeploymentStagingDeploymentsSignatureAlgorithm],
        pydantic.Field(alias="signatureAlgorithm"),
    ] = UNSET
    r"""Identifies the SHA (Secure Hash Algorithm) function. The NSA (National Security Agency) designed this function to produce a hash of certificate contents, which is used in a digital signature. This is either `SHA-1` for a 160-bit (20-byte) hash or `SHA-256` for a 256-bit (32-byte) hash. To ensure a secure hash function, use `SHA-256`."""
...
class GetDeploymentStagingResponseBodyTypedDict(TypedDict):
    ...
    network_configuration: GetDeploymentStagingNetworkConfigurationTypedDict
    r"""Network configuration properties."""
    primary_certificate: Nullable[GetDeploymentStagingPrimaryCertificateTypedDict]
    r"""Primary certificate of the enrollment."""
...
class GetDeploymentStagingResponseBody(BaseModel):
    r"""Deploys your certificate to a network."""

    multi_stacked_certificates: Annotated[
        List[GetDeploymentStagingMultiStackedCertificates],
    ...
    primary_certificate: Annotated[
        Nullable[GetDeploymentStagingPrimaryCertificate],
