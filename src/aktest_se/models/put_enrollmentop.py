...
class PutEnrollmentAdminContactTypedDict(TypedDict):
...
class PutEnrollmentAdminContact(BaseModel):
    r"""Contact information for the certificate administrator that you want to use as a contact at your company."""
...
class PutEnrollmentCertificateChainType(str, Enum):
...
class PutEnrollmentCertificateType(str, Enum):
...
class PutEnrollmentCsrTypedDict(TypedDict):
...
class PutEnrollmentCsr(BaseModel):
    r"""When you create an enrollment, you also generate a certificate signing request (CSR) using CPS. CPS signs the CSR with the private key. The CSR contains all the information the CA needs to issue your certificate."""
...
class PutEnrollmentOcspTypedDict(TypedDict):
...
class PutEnrollmentOcsp(BaseModel):
    r"""Whether you want to enable OCSP stapling for client certificates."""
...
class PutEnrollmentAuthenticationOptionsTypedDict(TypedDict):
    r"""Contains the configuration options for the selected trust chain."""

    ocsp: Nullable[PutEnrollmentOcspTypedDict]
    r"""Whether you want to enable OCSP stapling for client certificates."""
...
class PutEnrollmentAuthenticationOptions(BaseModel):
    r"""Contains the configuration options for the selected trust chain."""

    ocsp: Nullable[PutEnrollmentOcsp]
    r"""Whether you want to enable OCSP stapling for client certificates."""
...
class PutEnrollmentClientMutualAuthenticationTypedDict(TypedDict):
    ...
    authentication_options: Nullable[PutEnrollmentAuthenticationOptionsTypedDict]
    r"""Contains the configuration options for the selected trust chain."""
...
class PutEnrollmentClientMutualAuthentication(BaseModel):
    r"""The configuration for client mutual authentication. Specifies the trust chain that verifies client certificates and some configuration options."""

    authentication_options: Annotated[
        Nullable[PutEnrollmentAuthenticationOptions],
...
class PutEnrollmentDNSNameSettingsTypedDict(TypedDict):
    r"""DNS name settings."""
...
class PutEnrollmentDNSNameSettings(BaseModel):
    r"""DNS name settings."""
...
class PutEnrollmentGeography(str, Enum):
...
class PutEnrollmentOcspStapling(str, Enum):
...
class PutEnrollmentSecureNetwork(str, Enum):
...
class PutEnrollmentNetworkConfigurationTypedDict(TypedDict):
    ...
    geography: PutEnrollmentGeography
    r"""Specifies the type of network where you want to deploy your certificate.  Use `core` to deploy across most of the world except for specially licensed areas.  Use `china+core` to include China, or `russia+core` to include Russia. Any non-`core` deployment needs to be enabled on your contract based on approval from the Chinese or Russian governments."""
    quic_enabled: bool
    r"""Set to `true` to enable QUIC protocol."""
    secure_network: PutEnrollmentSecureNetwork
    r"""Identifies the type of deployment network. `enhanced-tls` means Akamai's more secure network with PCI compliance capability, while `standard-tls` means Akamai's standard secure network."""
    sni_only: bool
    ...
    client_mutual_authentication: NotRequired[
        Nullable[PutEnrollmentClientMutualAuthenticationTypedDict]
    ]
    r"""The configuration for client mutual authentication. Specifies the trust chain that verifies client certificates and some configuration options."""
    disallowed_tls_versions: NotRequired[Nullable[List[str]]]
    r"""Specify the TLS protocol versions you want to disallow."""
    dns_name_settings: NotRequired[Nullable[PutEnrollmentDNSNameSettingsTypedDict]]
    r"""DNS name settings."""
    ...
    ocsp_stapling: NotRequired[Nullable[PutEnrollmentOcspStapling]]
    r"""Enable OCSP stapling for the enrollment. OCSP Stapling improves performance by including a valid OCSP response in every TLS handshake. Specify OCSP Stapling if you want to improve performance by allowing your site's visitors to query the Online Certificate Status Protocol (OCSP) server at regular intervals to obtain a signed time-stamped OCSP response. This response needs to be signed by the CA, not the server, therefore ensuring security. Disable OSCP Stapling if you want your site's visitors to contact the CA directly for an OSCP response. You can use OCSP to obtain a certificate's revocation status. You should enable this feature. Use `on` to enable OSCP Stapling, `off` to disable it, or `not-set` to ignore it."""
...
class PutEnrollmentNetworkConfiguration(BaseModel):
    r"""Settings that specify any network information and TLS Metadata you want CPS to use to push the completed certificate to the network."""
    ...
    secure_network: Annotated[
        PutEnrollmentSecureNetwork, pydantic.Field(alias="secureNetwork")
    ]
    r"""Identifies the type of deployment network. `enhanced-tls` means Akamai's more secure network with PCI compliance capability, while `standard-tls` means Akamai's standard secure network."""
    ...
    client_mutual_authentication: Annotated[
        OptionalNullable[PutEnrollmentClientMutualAuthentication],
    ...
    dns_name_settings: Annotated[
        OptionalNullable[PutEnrollmentDNSNameSettings],
    ...
    ocsp_stapling: Annotated[
        OptionalNullable[PutEnrollmentOcspStapling],
...
class PutEnrollmentOrgTypedDict(TypedDict):
...
class PutEnrollmentOrg(BaseModel):
    r"""Your organization information."""
...
class PutEnrollmentChangeType(str, Enum):
...
class PutEnrollmentPendingChangesTypedDict(TypedDict):
    location: str
    r"""Location to fetch related change information."""
    change_type: NotRequired[Nullable[PutEnrollmentChangeType]]
    r"""Indicates the certificate's pending change action. This is either `new-certificate`, `modify-certificate`, `modify-san`, or `renewal`."""


class PutEnrollmentPendingChanges(BaseModel):
    location: str
    r"""Location to fetch related change information."""

    change_type: Annotated[
        OptionalNullable[PutEnrollmentChangeType], pydantic.Field(alias="changeType")
    ] = UNSET
    r"""Indicates the certificate's pending change action. This is either `new-certificate`, `modify-certificate`, `modify-san`, or `renewal`."""
...
class PutEnrollmentRa(str, Enum):
...
class PutEnrollmentSignatureAlgorithm(str, Enum):
...
class PutEnrollmentTechContactTypedDict(TypedDict):
...
class PutEnrollmentTechContact(BaseModel):
    r"""Contact information for an administrator at Akamai."""
...
class PutEnrollmentThirdPartyTypedDict(TypedDict):
...
class PutEnrollmentThirdParty(BaseModel):
    r"""Specifies that you want to use a third party certificate. This is any certificate that is not issued through CPS."""
...
class PutEnrollmentValidationType(str, Enum):
...
class PutEnrollmentRequestBodyTypedDict(TypedDict):
    ...
    certificate_type: PutEnrollmentCertificateType
    r"""Either `san`, `single`, `wildcard`, `wildcard-san`, or `third-party`. See [Enrollment.validationType Values](#validationtype) for details."""
    ...
    network_configuration: PutEnrollmentNetworkConfigurationTypedDict
    r"""Settings that specify any network information and TLS Metadata you want CPS to use to push the completed certificate to the network."""
    ra: PutEnrollmentRa
    r"""The registration authority or certificate authority (CA) you want to use to obtain a certificate. A CA is a trusted entity that signs certificates and can vouch for the identity of a website. This is either `symantec`,  `lets-encrypt`, or `third-party`."""
    validation_type: PutEnrollmentValidationType
    r"""CPS supports several types of validation: `dv`, `ev`, `ov`, or `third-party`. Domain Validation (`dv`) offers the lowest level of validation. The CA validates that you have control of the domain. CPS supports DV certificates issued by Let's Encrypt, a free, automated, and open CA, run for public benefit. Organization Validation (`ov`) offers the next level of validation. The CA validates that you have control of the domain. Extended Validation (`ev`) offers the highest level of validation, in which you need to have signed letters and notaries sent to the CA before signing. You can also specify `third-party` if you want to use a signed certificate you obtain from a CA that CPS doesn't directly support."""
    admin_contact: NotRequired[Nullable[PutEnrollmentAdminContactTypedDict]]
    r"""Contact information for the certificate administrator that you want to use as a contact at your company."""
    ...
    certificate_chain_type: NotRequired[Nullable[PutEnrollmentCertificateChainType]]
    r"""The kind of certificate trust chain. This is either `default` or `symantec1kroot`."""
    ...
    org: NotRequired[Nullable[PutEnrollmentOrgTypedDict]]
    r"""Your organization information."""
    ...
    pending_changes: NotRequired[Nullable[List[PutEnrollmentPendingChangesTypedDict]]]
    ...
    signature_algorithm: NotRequired[Nullable[PutEnrollmentSignatureAlgorithm]]
    r"""Identifies the SHA (Secure Hash Algorithm) function. The NSA (National Security Agency) designed this function to produce a hash of certificate contents, for use in a digital signature. This is either `SHA-1` for a 160-bit (20-byte) hash or `SHA-256` for a 256-bit (32-byte) hash. To ensure a secure hash function, use `SHA-256`."""
    staging_slots: NotRequired[Nullable[List[int]]]
    r"""Slots where the certificate is deployed on the staging network."""
    tech_contact: NotRequired[Nullable[PutEnrollmentTechContactTypedDict]]
    r"""Contact information for an administrator at Akamai."""
    third_party: NotRequired[Nullable[PutEnrollmentThirdPartyTypedDict]]
    r"""Specifies that you want to use a third party certificate. This is any certificate that is not issued through CPS."""


class PutEnrollmentRequestBody(BaseModel):
    r"""An enrollment displays all the information about the process that your certificate goes through from the time you request it, through renewal, and as you obtain subsequent versions. CPS is a certificate life cycle management tool. Once you obtain a certificate, you use it until it expires, in most cases a year from the date the CA issued the certificate. CPS automatically starts the renewal process 90 days before the old certificate expires. It then automatically deploys the renewed certificate when it receives it from the CA."""

    certificate_type: Annotated[
        PutEnrollmentCertificateType, pydantic.Field(alias="certificateType")
    ]
    r"""Either `san`, `single`, `wildcard`, `wildcard-san`, or `third-party`. See [Enrollment.validationType Values](#validationtype) for details."""
    ...
    network_configuration: Annotated[
        PutEnrollmentNetworkConfiguration, pydantic.Field(alias="networkConfiguration")
    ]
    r"""Settings that specify any network information and TLS Metadata you want CPS to use to push the completed certificate to the network."""
    ...
    validation_type: Annotated[
        PutEnrollmentValidationType, pydantic.Field(alias="validationType")
    ]
    r"""CPS supports several types of validation: `dv`, `ev`, `ov`, or `third-party`. Domain Validation (`dv`) offers the lowest level of validation. The CA validates that you have control of the domain. CPS supports DV certificates issued by Let's Encrypt, a free, automated, and open CA, run for public benefit. Organization Validation (`ov`) offers the next level of validation. The CA validates that you have control of the domain. Extended Validation (`ev`) offers the highest level of validation, in which you need to have signed letters and notaries sent to the CA before signing. You can also specify `third-party` if you want to use a signed certificate you obtain from a CA that CPS doesn't directly support."""

    admin_contact: Annotated[
        OptionalNullable[PutEnrollmentAdminContact],
    ...
    certificate_chain_type: Annotated[
        OptionalNullable[PutEnrollmentCertificateChainType],
    ...
    org: OptionalNullable[PutEnrollmentOrg] = UNSET
    r"""Your organization information."""
    ...
    pending_changes: Annotated[
        OptionalNullable[List[PutEnrollmentPendingChanges]],
    ...
    signature_algorithm: Annotated[
        OptionalNullable[PutEnrollmentSignatureAlgorithm],
    ...
    tech_contact: Annotated[
        OptionalNullable[PutEnrollmentTechContact], pydantic.Field(alias="techContact")
    ] = UNSET
    r"""Contact information for an administrator at Akamai."""

    third_party: Annotated[
        OptionalNullable[PutEnrollmentThirdParty], pydantic.Field(alias="thirdParty")
    ] = UNSET
    r"""Specifies that you want to use a third party certificate. This is any certificate that is not issued through CPS."""
...
class PutEnrollmentRequestTypedDict(TypedDict):
    enrollment_id: int
    r"""Enrollment on which to perform the desired operation."""
    request_body: PutEnrollmentRequestBodyTypedDict
    allow_cancel_pending_changes: NotRequired[bool]
    r"""Cancels all pending changes when updating an enrollment."""
    allow_staging_bypass: NotRequired[bool]
    r"""Bypass staging and push metadata updates directly to the production network. The current change also updates with the same changes."""
    ...
    r"""Force certificate renewal for Enrollment."""
    renewal_date_check_override: NotRequired[bool]
    r"""CPS automatically starts a change to renew certificates in time before they expire. This automatic change starts when the certificate's expiration is within a renewal window. CPS prevents other changes from starting during this renewal window. Setting `renewal-date-check-override=true` allows changes during the renewal window, potentially running the risk of an expired certificate on the network."""
    allow_missing_certificate_addition: NotRequired[bool]
    r"""Applicable for Third Party Dual Stack Enrollments, allows to update missing certificate. Option supported from v10."""
    account_switch_key: NotRequired[str]
    r"""For customers who manage more than one account, this [runs the operation from another account](https://techdocs.akamai.com/developer/docs/manage-many-accounts-with-one-api-client). The Identity and Access Management API provides a [list of available account switch keys](https://techdocs.akamai.com/iam-api/reference/get-client-account-switch-keys)."""


class PutEnrollmentRequest(BaseModel):
    ...
    request_body: Annotated[
        ...
        FieldMetadata(
            request=RequestMetadata(
                media_type="application/vnd.akamai.cps.enrollment.v12+json"
            )
        ),
    ]
    ...
    allow_staging_bypass: Annotated[
        Optional[bool],
        pydantic.Field(alias="allow-staging-bypass"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Bypass staging and push metadata updates directly to the production network. The current change also updates with the same changes."""
    ...
    force_renewal: Annotated[
        Optional[bool],
        pydantic.Field(alias="force-renewal"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Force certificate renewal for Enrollment."""

    renewal_date_check_override: Annotated[
        Optional[bool],
        pydantic.Field(alias="renewal-date-check-override"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""CPS automatically starts a change to renew certificates in time before they expire. This automatic change starts when the certificate's expiration is within a renewal window. CPS prevents other changes from starting during this renewal window. Setting `renewal-date-check-override=true` allows changes during the renewal window, potentially running the risk of an expired certificate on the network."""

    allow_missing_certificate_addition: Annotated[
        Optional[bool],
        pydantic.Field(alias="allow-missing-certificate-addition"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""Applicable for Third Party Dual Stack Enrollments, allows to update missing certificate. Option supported from v10."""
...
class PutEnrollmentEnrollmentsResponseBodyTypedDict(TypedDict):
...
class PutEnrollmentEnrollmentsResponseBody(BaseModel):
    r"""Encapsulates information for enrollment status."""
...
class PutEnrollmentResponseBodyTypedDict(TypedDict):
    r"""Encapsulates information for enrollment status."""
...
class PutEnrollmentResponseBody(BaseModel):
    r"""Encapsulates information for enrollment status."""
...
PutEnrollmentResponseTypedDict = Union[
    PutEnrollmentResponseBodyTypedDict, PutEnrollmentEnrollmentsResponseBodyTypedDict
]


PutEnrollmentResponse = Union[
    PutEnrollmentResponseBody, PutEnrollmentEnrollmentsResponseBody
]
